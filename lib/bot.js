...
function bot(torrent, bot) {
  ...
  bot.on('callback_query', async callbackQuery => {
    ...
    if (action === 'drive') {
      text = '_You will have to Join our Team Drive For_ *Accessing and Downloading Files from Google Drive.*\n\n_To Join our Team Drive, Join Our Google Group and you are Good to go!_\n\n_Link to Join Google Group ⬇️_\n*https://groups.google.com/g/cloudtorrenter*\n\n_After Joining, visit Google Drive for Accessing and Downloading Files!_\n\n_Google Drive Link ⬇️_\n*https://drive.google.com/drive/folders/0AMTkervhUwARUk9PVA*';
    }
