...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bot.on('callback_query', async callbackQuery => {
    ...
    const opts = {
      chat_id: callbackQuery.chat.id,
      message_id: update.msg.message_id,
    };
    let text;

    if (action === 'grouplink') {
      bot.sendMessage('https://groups.google.com/g/cloudtorrenter', opts);
    }
  });
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bot.on('callback_query', async callbackQuery => {
    ...
    if (action === 'drivelink') {
      bot.sendMessage('https://drive.google.com/drive/folders/0AMTkervhUwARUk9PVA', opts);
    }
  });
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bot.on('callback_query', async callbackQuery => {
    ...
    const opts = {
      ...
      chat_id: msg.chat.id,
      message_id: callbackQuery.chat.id,
      disable_web_page_preview: 'true',
    };
    let text;

    if (action === 'advancedhelp') {
      bot.sendMessage('https://telegra.ph/Advanced-Help-for-Cloud-Torrenter-07-31', opts);
    }
  });
//
//
