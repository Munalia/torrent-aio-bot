...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bot.on('callback_query', async callbackQuery => {
    ...
    if (action === 'drivelink') {
      bot.sendMessage(chatId, 'https://drive.google.com/drive/folders/0AMTkervhUwARUk9PVA', opts);
    }
  });
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
  bot.on('callback_query', async callbackQuery => {
    ...
    if (action === 'advancedhelp') {
      bot.sendMessage(chatId, 'https://telegra.ph/Advanced-Help-for-Cloud-Torrenter-07-31', opts);
    }
  });
//
//
